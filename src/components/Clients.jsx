    ...
    <div className='clients' id='testimonios'>
        ...
        <div className='title'>
            ...
            <h2>Conoce los testimonios de <br />nuestros clientes.</h2>
             ...
             target="_blank" rel="noreferrer" aria-label='Perfil de Google Negocios' title='Perfil de Google Negocios' className='cta-btn_black'>Ver reseñas <img src={arrow} alt="flecha"/></a>
        </div>
    </div>
  )
}
